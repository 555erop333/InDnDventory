...
const Auth: React.FC<AuthProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-dnd-dark flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full bg-[url('https://www.transparenttextures.com/patterns/dark-leather.png')] opacity-50 pointer-events-none" />
      <div className="absolute -top-20 -left-20 w-64 h-64 bg-dnd-gold/5 rounded-full blur-3xl" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-dnd-accent/5 rounded-full blur-3xl" />
      ...
      <div className="bg-dnd-panel border border-dnd-muted p-8 rounded-2xl shadow-2xl max-w-md w-full relative z-10 backdrop-blur-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-dnd-gold tracking-wide">D&D Master</h1>
